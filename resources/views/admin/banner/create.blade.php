        ...
        <div class="card-body">
            ...
            <form action="{{ route('banners.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <textarea class=" @error('description') is-invalid @enderror form-control" rows="6" name="description">{{ old('description') }}</textarea>
                    @error('description')
                ...
                <button class="btn lg_btn btn-primary float-end">Add Banner</button>
            </form>
        </div>
    </div>
    <script>
